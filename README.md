...
python ganspace.py --obj cat --comp_id 27 --scalar 20 --layers 10,18 --ckpt weights/photosketch_standing_cat_noaug.pth --save_dir output/ganspace_fur_standing_cat
