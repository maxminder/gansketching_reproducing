...
python ganspace.py --obj cat --comp_id 1 --scalar 10 --layers 2,5 --ckpt weights/photosketch_standing_cat_noaug.pth --save_dir output/ganspace_fur_standing_cat --slice 2
